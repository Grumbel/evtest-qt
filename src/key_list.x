// autogenerated by 'gen_event_lists.py', do not edit by hand
  ...
  add(KEY_ALL_APPLICATIONS, "KEY_ALL_APPLICATIONS");
#endif
  ...
  add(KEY_FULL_SCREEN, "KEY_FULL_SCREEN");
#endif
  ...
  add(KEY_ASPECT_RATIO, "KEY_ASPECT_RATIO");
#endif
  ...
  add(KEY_NOTIFICATION_CENTER, "KEY_NOTIFICATION_CENTER");
#endif

#ifdef KEY_PICKUP_PHONE
  add(KEY_PICKUP_PHONE, "KEY_PICKUP_PHONE");
#endif

#ifdef KEY_HANGUP_PHONE
  add(KEY_HANGUP_PHONE, "KEY_HANGUP_PHONE");
#endif
  ...
  add(KEY_FN_RIGHT_SHIFT, "KEY_FN_RIGHT_SHIFT");
#endif
  ...
  add(KEY_ROTATE_LOCK_TOGGLE, "KEY_ROTATE_LOCK_TOGGLE");
#endif
...
#ifdef KEY_ASSISTANT
  add(KEY_ASSISTANT, "KEY_ASSISTANT");
#endif

#ifdef KEY_KBD_LAYOUT_NEXT
  add(KEY_KBD_LAYOUT_NEXT, "KEY_KBD_LAYOUT_NEXT");
#endif

#ifdef KEY_EMOJI_PICKER
  add(KEY_EMOJI_PICKER, "KEY_EMOJI_PICKER");
#endif

#ifdef KEY_DICTATE
  add(KEY_DICTATE, "KEY_DICTATE");
#endif
...
#ifdef KEY_RIGHT_UP
  add(KEY_RIGHT_UP, "KEY_RIGHT_UP");
#endif

#ifdef KEY_RIGHT_DOWN
  add(KEY_RIGHT_DOWN, "KEY_RIGHT_DOWN");
#endif

#ifdef KEY_LEFT_UP
  add(KEY_LEFT_UP, "KEY_LEFT_UP");
#endif

#ifdef KEY_LEFT_DOWN
  add(KEY_LEFT_DOWN, "KEY_LEFT_DOWN");
#endif

#ifdef KEY_ROOT_MENU
  add(KEY_ROOT_MENU, "KEY_ROOT_MENU");
#endif

#ifdef KEY_MEDIA_TOP_MENU
  add(KEY_MEDIA_TOP_MENU, "KEY_MEDIA_TOP_MENU");
#endif

#ifdef KEY_NUMERIC_11
  add(KEY_NUMERIC_11, "KEY_NUMERIC_11");
#endif

#ifdef KEY_NUMERIC_12
  add(KEY_NUMERIC_12, "KEY_NUMERIC_12");
#endif

#ifdef KEY_AUDIO_DESC
  add(KEY_AUDIO_DESC, "KEY_AUDIO_DESC");
#endif

#ifdef KEY_3D_MODE
  add(KEY_3D_MODE, "KEY_3D_MODE");
#endif

#ifdef KEY_NEXT_FAVORITE
  add(KEY_NEXT_FAVORITE, "KEY_NEXT_FAVORITE");
#endif

#ifdef KEY_STOP_RECORD
  add(KEY_STOP_RECORD, "KEY_STOP_RECORD");
#endif

#ifdef KEY_PAUSE_RECORD
  add(KEY_PAUSE_RECORD, "KEY_PAUSE_RECORD");
#endif
...
#ifdef KEY_UNMUTE
  add(KEY_UNMUTE, "KEY_UNMUTE");
#endif

#ifdef KEY_FASTREVERSE
  add(KEY_FASTREVERSE, "KEY_FASTREVERSE");
#endif

#ifdef KEY_SLOWREVERSE
  add(KEY_SLOWREVERSE, "KEY_SLOWREVERSE");
#endif

#ifdef KEY_DATA
  add(KEY_DATA, "KEY_DATA");
#endif

#ifdef KEY_ONSCREEN_KEYBOARD
  add(KEY_ONSCREEN_KEYBOARD, "KEY_ONSCREEN_KEYBOARD");
#endif

#ifdef KEY_PRIVACY_SCREEN_TOGGLE
  add(KEY_PRIVACY_SCREEN_TOGGLE, "KEY_PRIVACY_SCREEN_TOGGLE");
#endif

#ifdef KEY_SELECTIVE_SCREENSHOT
  add(KEY_SELECTIVE_SCREENSHOT, "KEY_SELECTIVE_SCREENSHOT");
#endif

#ifdef KEY_MACRO1
  add(KEY_MACRO1, "KEY_MACRO1");
#endif

#ifdef KEY_MACRO2
  add(KEY_MACRO2, "KEY_MACRO2");
#endif

#ifdef KEY_MACRO3
  add(KEY_MACRO3, "KEY_MACRO3");
#endif

#ifdef KEY_MACRO4
  add(KEY_MACRO4, "KEY_MACRO4");
#endif

#ifdef KEY_MACRO5
  add(KEY_MACRO5, "KEY_MACRO5");
#endif

#ifdef KEY_MACRO6
  add(KEY_MACRO6, "KEY_MACRO6");
#endif

#ifdef KEY_MACRO7
  add(KEY_MACRO7, "KEY_MACRO7");
#endif

#ifdef KEY_MACRO8
  add(KEY_MACRO8, "KEY_MACRO8");
#endif

#ifdef KEY_MACRO9
  add(KEY_MACRO9, "KEY_MACRO9");
#endif

#ifdef KEY_MACRO10
  add(KEY_MACRO10, "KEY_MACRO10");
#endif

#ifdef KEY_MACRO11
  add(KEY_MACRO11, "KEY_MACRO11");
#endif

#ifdef KEY_MACRO12
  add(KEY_MACRO12, "KEY_MACRO12");
#endif

#ifdef KEY_MACRO13
  add(KEY_MACRO13, "KEY_MACRO13");
#endif

#ifdef KEY_MACRO14
  add(KEY_MACRO14, "KEY_MACRO14");
#endif

#ifdef KEY_MACRO15
  add(KEY_MACRO15, "KEY_MACRO15");
#endif

#ifdef KEY_MACRO16
  add(KEY_MACRO16, "KEY_MACRO16");
#endif

#ifdef KEY_MACRO17
  add(KEY_MACRO17, "KEY_MACRO17");
#endif

#ifdef KEY_MACRO18
  add(KEY_MACRO18, "KEY_MACRO18");
#endif

#ifdef KEY_MACRO19
  add(KEY_MACRO19, "KEY_MACRO19");
#endif

#ifdef KEY_MACRO20
  add(KEY_MACRO20, "KEY_MACRO20");
#endif

#ifdef KEY_MACRO21
  add(KEY_MACRO21, "KEY_MACRO21");
#endif

#ifdef KEY_MACRO22
  add(KEY_MACRO22, "KEY_MACRO22");
#endif

#ifdef KEY_MACRO23
  add(KEY_MACRO23, "KEY_MACRO23");
#endif

#ifdef KEY_MACRO24
  add(KEY_MACRO24, "KEY_MACRO24");
#endif

#ifdef KEY_MACRO25
  add(KEY_MACRO25, "KEY_MACRO25");
#endif

#ifdef KEY_MACRO26
  add(KEY_MACRO26, "KEY_MACRO26");
#endif

#ifdef KEY_MACRO27
  add(KEY_MACRO27, "KEY_MACRO27");
#endif

#ifdef KEY_MACRO28
  add(KEY_MACRO28, "KEY_MACRO28");
#endif

#ifdef KEY_MACRO29
  add(KEY_MACRO29, "KEY_MACRO29");
#endif

#ifdef KEY_MACRO30
  add(KEY_MACRO30, "KEY_MACRO30");
#endif

#ifdef KEY_MACRO_RECORD_START
  add(KEY_MACRO_RECORD_START, "KEY_MACRO_RECORD_START");
#endif

#ifdef KEY_MACRO_RECORD_STOP
  add(KEY_MACRO_RECORD_STOP, "KEY_MACRO_RECORD_STOP");
#endif

#ifdef KEY_MACRO_PRESET_CYCLE
  add(KEY_MACRO_PRESET_CYCLE, "KEY_MACRO_PRESET_CYCLE");
#endif

#ifdef KEY_MACRO_PRESET1
  add(KEY_MACRO_PRESET1, "KEY_MACRO_PRESET1");
#endif

#ifdef KEY_MACRO_PRESET2
  add(KEY_MACRO_PRESET2, "KEY_MACRO_PRESET2");
#endif

#ifdef KEY_MACRO_PRESET3
  add(KEY_MACRO_PRESET3, "KEY_MACRO_PRESET3");
#endif

#ifdef KEY_KBD_LCD_MENU1
  add(KEY_KBD_LCD_MENU1, "KEY_KBD_LCD_MENU1");
#endif

#ifdef KEY_KBD_LCD_MENU2
  add(KEY_KBD_LCD_MENU2, "KEY_KBD_LCD_MENU2");
#endif

#ifdef KEY_KBD_LCD_MENU3
  add(KEY_KBD_LCD_MENU3, "KEY_KBD_LCD_MENU3");
#endif

#ifdef KEY_KBD_LCD_MENU4
  add(KEY_KBD_LCD_MENU4, "KEY_KBD_LCD_MENU4");
#endif

#ifdef KEY_KBD_LCD_MENU5
  add(KEY_KBD_LCD_MENU5, "KEY_KBD_LCD_MENU5");
#endif
